...
public class Input {
    public static List<Point> getPoints() {
        ...
        for (String line: lines) {
            ...
            int y = Integer.parseInt(line.substring(0, line.indexOf(">")).trim());
            line = line.substring(line.indexOf(">") + 1);
            int velX = Integer.parseInt(line.substring(line.indexOf("<") + 1, line.indexOf(",")).trim());
            line = line.substring(line.indexOf(",") + 1);
            int velY = Integer.parseInt(line.substring(0, line.indexOf(">")).trim());
            Point p = new Point();
            p.X = x;
            p.Y = y;
            p.VelX = velX;
    ...
    public static String get() {
        return "position=<-52592,  31869> velocity=< 5, -3>\n" +
