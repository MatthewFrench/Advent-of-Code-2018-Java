...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of guards: " + guardMap.size());
        ...
        for (Map.Entry<String, HashMap<String, Integer>> e : guardMap.entrySet()) {
            ...
            System.out.println("Guard " + guardId + " slept for " + minutesAsleep);
        ...
        System.out.println("Most sleep guard: " + mostSleepyGuardId + " with minute: " + maxMostSleptMinute +
                " with sleep time for that mintues: " + maxMostSleptMinuteTimes + ", with total sleep time: " + maxMostSleptMinutesTotal);
        System.out.println("Id of guard * minute = " + (Integer.parseInt(mostSleepyGuardId) * maxMostSleptMinute));
        ...
        System.out.println("Most minute sleep guard: " + mostSleepyGuardId + " with minute: " + maxMostSleptMinute +
                " with sleep time for that mintues: " + maxMostSleptMinuteTimes + ", with total sleep time: " + maxMostSleptMinutesTotal);
        System.out.println("Id of guard * minute = " + (Integer.parseInt(mostSleepyGuardId) * maxMostSleptMinute));
